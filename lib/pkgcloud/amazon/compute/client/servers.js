...
//
exports.getRegions = function getRegions(callback) {
  return this._query(
    'describeRegions',
    {  },
    function (err, body, res) {
      return err
        ...
        : callback && callback(null, { ok: "sucsses" }, res);
    }
  );
};
...
//
// ### function AttachVolume(server, callback)
// #### @server {Server|String} Server id or a server
// #### @callback {Function} f(err, serverId).
//
// AttachVolume a server in AWS.
//
exports.AttachVolume = function AttachVolume(obj, callback) {
...
exports.startServer = function startServer(server, callback) {
  ...
  return this._query(
    ...
    function (err, body, res) {
      return err
        ? callback(err)
        : callback(null, { ok: serverId }, res, body);
    }
  );
};
...
//
// ### function DescribeInstances (server, options, callback)
// #### @server   {Server|String} The server to reboot
// #### @callback {Function} f(err, server).
//
// start a server
//
exports.DescribeInstances = function DescribeInstances(server, callback) {
  var serverId = server instanceof base.Server ? server.id : server;
  var self = this;
  ...
  return this._query(
    ...
    function (err, body, res) {
	  ...
	  var obj = {};
	  try{
		  obj = body.reservationSet.item.instancesSet.item;
	  }catch(e){
		  obj = {};
	  }
	  body.obj_resp = obj;
